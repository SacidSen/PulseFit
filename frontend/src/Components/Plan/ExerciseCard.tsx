...
export default function ExerciseCard({name}: ExerciseProps) {
    return(
        <div className="h-16 w-full px-4 mb-10">
            <div className="border rounded-md border-gray-400 h-full flex items-center justify-start">
                <div className="flex grow px-2 items-center justify-start">
                    <input className="w-5 h-5 mr-4 rounded outline-none" type="checkbox" />
