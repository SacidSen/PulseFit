                ...
                <div className="flex grow flex-col justify-center items-center px-2">
                    ...
                    <div className="flex items-center flex-wrap justify-center">
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" className="bi bi-trophy" viewBox="0 0 16 16">
                            ...
                            {/* <p>{ambition}</p> */}
                            <p className="font-semibold text-sm ml-1">Build Muscle</p>
                        </div>
                        <div className="flex items-center mx-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" className="bi bi-person-arms-up" viewBox="0 0 16 16">
